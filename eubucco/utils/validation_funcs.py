...
def get_num_rows(path_input_parsing = '/p/projects/eubucco/git-eubucco/database/preprocessing/1-parsing/inputs-parsing.csv', 
    ...
    for index, row in df.iterrows():
        ...
        print('geom:{}, attrib:{},x_attrib:{},num_sources:{},num_match:{}'.format(num_geoms,num_attrib,num_x_attrib,num_sources,num_match))
        print('....')
...
def geom_validation(path_input_parsing = '/p/projects/eubucco/git-eubucco/database/preprocessing/1-parsing/inputs-parsing.csv', 
                path_root = '/p/projects/eubucco/data/1-intermediary-outputs',
                path_out = '/p/projects/eubucco/stats/1-parsing/validation/'):
    """
...
def get_num_rows_city(path_input_parsing = '/p/projects/eubucco/git-eubucco/database/preprocessing/1-parsing/inputs-parsing.csv', path_out = '/p/projects/eubucco/stats/1-parsing/validation'):
    """
