...
from ufo_map.Utils.helpers import import_csv_w_wkt_to_gdf, get_all_paths
...
def create_features(country_name,
    ...
    '''
        ...
        TODO:
                * improve the get_stats ouputs locations/names
    ...
    buffer_ = import_csv_w_wkt_to_gdf(paths['buffer'], CRS)
    ...
    if int_:
        intersections = import_csv_w_wkt_to_gdf(paths['intersections'], CRS)
    ...
    if sbb_:
        sbb = import_csv_w_wkt_to_gdf(paths['sbb'], CRS)
