...
parse(path_to_param_file='/Users/felix/code/eubucco/database/preprocessing/1-parsing/inputs-parsing-v1-cluster-test.csv',
    path_output='/Users/felix/code/eubucco_data/parsing',
    path_stats='/Users/felix/code/eubucco_data/parsing',
    test_run=True,
    arg_as_param=True
    )